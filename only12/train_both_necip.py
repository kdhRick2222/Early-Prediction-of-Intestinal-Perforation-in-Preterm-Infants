...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default="./KNN_final/only12/KNNdata_only12.csv")
    parser.add_argument('--outputs-dir', type=str, default="./KNN_final/only12/weight_rev")
