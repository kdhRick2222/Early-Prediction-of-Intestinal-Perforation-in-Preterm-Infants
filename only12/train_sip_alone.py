...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_epochs):
        ...
        torch.save(model.state_dict(), os.path.join(args.outputs_dir, 'sip_{}.pth'.format(epoch)))
        ...
        print("EPOCH : {0:3d}  iperr_loss : {1:0.4f}  AUC_iperr : {2:0.4f}, ppv : {3:0.4f}, npv : {4:0.4f}, sensitivity : {5:0.4f}"
