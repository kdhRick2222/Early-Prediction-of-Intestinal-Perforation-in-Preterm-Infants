...
if __name__ == '__main__':
    ...
    # Adam  (1e-3, 256, 0.7633)
    # SGD   (1e-2, 128, 0.7591), (1e-3, 128, 0.7552)
    ...
    for epoch in range(args.num_epochs):
        ...
        print("EPOCH : {0:3d}  nec_loss : {1:0.4f}  AUC_nec : {2:0.4f}, ppv : {3:0.4f}, npv : {4:0.4f}, sensitivity : {5:0.4f}"
