...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_epochs):
        ...
        for data in train_dataloader:
            ...
            loss1 = criterion(pdad.squeeze(1), labels1)
            loss2 = criterion(ntet.squeeze(1), labels2)
            loss = loss2 + loss1
            loss_sum1 += loss1
            loss_sum2 += loss2
        ...
        pdad_loss = (pdad_loss1/n1) + (pdad_loss2/n2)
        ntet_loss = (ntet_loss1/n1) + (ntet_loss2/n2)
        pdad_acc = (pdad1_acc/n1 + pdad2_acc/n2) * 0.5
        ntet_acc = (ntet1_acc/n1 + ntet2_acc/n2) * 0.5

        print("EPOCH : {0:3d}  pdad_loss : {1:0.4f}  ntet_loss : {2:0.4f}  pdad : {3:0.4f}  ntet : {4:0.4f}  pdad1 : {5:0.4f}  pdad2 : {6:0.4f}  ntet1 : {7:0.4f}  ntet2 : {8:0.4f}".format(epoch, pdad_loss, ntet_loss, pdad_acc, ntet_acc, pdad1_acc/n1, pdad2_acc/n2, ntet1_acc/n1, ntet2_acc/n2))
