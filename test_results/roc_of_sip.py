...
def roc_curve_plot(l1, l2, p1, p2, p3):
    ...
    plt.legend()
    plt.savefig('/home/daehyun/KNN_final/test_results/roc/57sip_roc_curve.png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test', type=str, default="/home/daehyun/KNN_final/test_results/test_dataset2019_57.csv") #57개 데이터
    ...
    eval_dataset = EvalDataset_sip(args.data, args.test)
    eval_dataloader = DataLoader(dataset=eval_dataset, batch_size=1)

    eval_dataset_both = EvalDataset_sip_both(args.data, args.test)
    ...
    # best_threshold1 = 0.434743195772171
    ...
    # best_threshold2 = 0.04161541163921356
    ...
    # best_threshold3 = 0.01050224807113409
