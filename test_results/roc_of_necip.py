...
def roc_curve_plot(l1, l2, p1, p2, p3):
    ...
    plt.legend()
    plt.savefig('/home/daehyun/KNN_final/test_results/roc/57necip_roc_curve.png')
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model1_weight', type=str, default="/home/daehyun/KNN_final/test_results/weight/necip_alone.pth")
    # parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN_final/test_results/weight/necip_both.pth")
    # parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN_final/test_results/weight/necip_transfer.pth")
    parser.add_argument('--model1_weight', type=str, default="/home/daehyun/KNN_final/only12/weight_re/necip_alone2.pth")
    parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN_final/only12/weight_re/necip_both2.pth")
    parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN_final/only12/weight_re/necip_transfer2.pth")
    ...
    eval_dataset = EvalDataset_necip(args.data, args.test)
    eval_dataloader = DataLoader(dataset=eval_dataset, batch_size=1)

    eval_dataset_both = EvalDataset_necip_both(args.data, args.test)
    ...
    # best_threshold1 = 0.50023353099823
    ...
    # best_threshold2 = 0.7187286019325256
