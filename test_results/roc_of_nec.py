...
def roc_curve_plot(l1, l2, p1, p2, p3):
    ...
    plt.legend()
    plt.savefig('/home/daehyun/KNN_final/test_results/roc/57nec_roc_curve.png')
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model1_weight', type=str, default='/home/daehyun/KNN_final/test_results/weight/nec_alone.pth')#"/home/daehyun/KNN/roc_curve_12/weight_12/nec_alone.pth")
    ...
    # parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN_final/test_results/weight_re/nec_both.pth")
    # parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN_final/test_results/weight_re/nec_transfer.pth")
    ...
    eval_dataset = EvalDataset_nec(args.data, args.test)
    eval_dataloader = DataLoader(dataset=eval_dataset, batch_size=1)

    eval_dataset_both = EvalDataset_nec_both(args.data, args.test)
    ...
    # best_threshold1 = 0.665145754814148
    ...
    # best_threshold2 = 0.6217005252838135
    ...
    # best_threshold3 = 0.39556246995925903
