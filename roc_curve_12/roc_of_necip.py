...
def roc_curve_plot(l1, l2, p1, p2, p3):
    ...
    plt.legend()
    plt.savefig('/home/daehyun/KNN_final/roc_curve_12/roc/necip_roc_curve.png')
...
if __name__ == '__main__':
    ...
    eval_dataset1_both = EvalDataset1_necip_both(args.data)
    eval_dataloader1_both = DataLoader(dataset=eval_dataset1_both, batch_size=1)
    eval_dataset2_both = EvalDataset2_necip_both(args.data)
