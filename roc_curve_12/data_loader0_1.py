...
class TrainDataset_nec(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        l = np.concatenate((self.np_df1[:8000, 54:], self.np_df1[9618:, 54:], self.df2_train[:9000, 54:]), axis=0)
    ...
    def __len__(self):
        return len(np.concatenate((self.np_df1[:8000, 54:], self.np_df1[9618:, 54:], self.df2_train[:9000, 54:]), axis=0))
...
class TrainDataset_necip(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        l = np.concatenate((self.np_df1[:8000, 54:], self.np_df1[9962:, 54:], self.df2_train[:9000, 54:]), axis=0)
    ...
    def __len__(self):
        return len(np.concatenate((self.np_df1[:8000, 54:], self.np_df1[9962:, 54:], self.df2_train[:9000, 54:]), axis=0))
...
class EvalDataset2_necip(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # labeldata2 = torch.FloatTensor(self.df2_test[:1962, 54:][idx]) - 1.
        return testdata2, labeldata2
...
class TrainDataset_sip(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        l = np.concatenate((self.np_df1[:8000, 54:], self.np_df1[10500:, 54:], self.df2_train[:11000, 54:]), axis=0)
    ...
    def __len__(self):
        return len(np.concatenate((self.np_df1[:8000, 54:], self.np_df1[10500:, 54:], self.df2_train[:11000, 54:]), axis=0))
...
class EvalDataset2_sip(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # labeldata2 = torch.FloatTensor(self.df2_test[:2000, 54:][idx]) - 1.
