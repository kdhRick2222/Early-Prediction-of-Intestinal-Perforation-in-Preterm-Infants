...
class TrainDataset_nec_both(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        t = np.concatenate((self.np_df1[:8000, :54], self.np_df1[9618:, :54], self.df2_train[:9000, :54]), axis=0)
        l1 = np.concatenate((self.np_df1[:8000, 54], self.np_df1[9618:, 54], self.df2_train[:9000, 54]), axis=0)
        l2 = np.concatenate((self.np_df1[:8000, 55], self.np_df1[9618:, 55], self.df2_train[:9000, 55]), axis=0)
    ...
    def __len__(self):
        return len(np.concatenate((self.np_df1[:8000, 55], self.np_df1[9618:, 55], self.df2_train[:9000, 55]), axis=0))
...
class EvalDataset2_nec_both(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # labeldata1 = torch.FloatTensor(self.df2_test[:1618, 54:55][idx]) - 1.
        # labeldata2 = torch.FloatTensor(self.df2_test[:1618, 55:56][idx]) - 1.
...
class TrainDataset_necip_both(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        t = np.concatenate((self.np_df1[:8000, :54], self.np_df1[9962:, :54], self.df2_train[:9000, :54]), axis=0)
        l1 = np.concatenate((self.np_df1[:8000, 54], self.np_df1[9962:, 54], self.df2_train[:9000, 54]), axis=0)
        l2 = np.concatenate((self.np_df1[:8000, 55], self.np_df1[9962:, 55], self.df2_train[:9000, 55]), axis=0)
    ...
    def __len__(self):
        return len(np.concatenate((self.np_df1[:8000, 55], self.np_df1[9962:, 55], self.df2_train[:9000, 55]), axis=0))
...
class EvalDataset2_necip_both(Dataset):
    def __init__(self, knnfile):
        ...
        for i in range(90):
            self.df2_test = np.concatenate((self.df2_test, self.np_df2[380:428, :]))
    ...
    def __getitem__(self, idx):
        ...
        # testdata2 = torch.FloatTensor(self.df2_test[:1962, :54][idx])
        # labeldata1 = torch.FloatTensor(self.df2_test[:1962, 54:55][idx]) - 1.
        # labeldata2 = torch.FloatTensor(self.df2_test[:1962, 55:56][idx]) - 1.

        return testdata2, labeldata1, labeldata2

    def __len__(self):
        length = len(self.np_df2[380:428, :])
        # length = len(self.df2_test[:1962, :])
        return length
...
class TrainDataset_sip_both(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        t = np.concatenate((self.np_df1[:8000, :54], self.np_df1[10500:, :54], self.df2_train[:11000, :54]), axis=0)
        l1 = np.concatenate((self.np_df1[:8000, 54], self.np_df1[10500:, 54], self.df2_train[:11000, 54]), axis=0)
        l2 = np.concatenate((self.np_df1[:8000, 55], self.np_df1[10500:, 55], self.df2_train[:11000, 55]), axis=0)
    ...
    def __len__(self):
        return len(np.concatenate((self.np_df1[:8000, 55], self.np_df1[10500:, 55], self.df2_train[:11000, 55]), axis=0))
...
class EvalDataset2_sip_both(Dataset):
    def __init__(self, knnfile):
        ...
        self.df2_test = self.np_df2[170:, :]

        for i in range(90):
            self.df2_test = np.concatenate((self.df2_test, self.np_df2[170:, :]))
    ...
    def __getitem__(self, idx):
        ...
        # testdata2 = torch.FloatTensor(self.df2_test[:2000, :54][idx])
        # labeldata1 = torch.FloatTensor(self.df2_test[:2000, 54:55][idx]) - 1.
        # labeldata2 = torch.FloatTensor(self.df2_test[:2000, 55:56][idx]) - 1.
        return testdata2, labeldata1, labeldata2

    def __len__(self):
        length = len(self.np_df2[170:, :])
        # length = len(self.df2_test[:2000, :])
        return length
