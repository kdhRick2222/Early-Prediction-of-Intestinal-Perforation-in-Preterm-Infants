...
def roc_curve_plot(l1, l2, p1, p2, p3):
    ...
    plt.legend()
    plt.savefig('/home/daehyun/KNN/roc_curve/roc/sip_roc_curve.png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model1_weight', type=str, default="/home/daehyun/KNN/roc_curve/weight/alone_iperr.pth")
    parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN/roc_curve/weight/train_both_iperr.pth")
    parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN/roc_curve/weight/transfer_iperr_roc.pt")
