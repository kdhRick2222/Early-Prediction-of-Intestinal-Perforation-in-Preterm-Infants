...
def roc_curve_plot(l1, l2, p1, p2, p3):
    ...
    plt.legend()
    plt.savefig('/home/daehyun/KNN_final/roc_curve_12/roc/sip_roc_curve.png')
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model1_weight', type=str, default="/home/daehyun/KNN_final/roc_curve_12/weight/sip_alone2.pth")
    # parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN_final/roc_curve_12/weight/sip_both_8074.pth")
    # parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN_final/roc_curve_12/weight/sip_transfer_8029.pth")
    # parser.add_argument('--model1_weight', type=str, default="/home/daehyun/KNN_final/roc_curve_12/weight/sip_alone2.pth")
    # parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN_final/only12/weight/sip_both_8109.pth")
    # parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN_final/roc_curve_12/weight/sip_transfer_8029.pth")
    parser.add_argument('--model1_weight', type=str, default="/home/daehyun/KNN_final/only12/weight_re/sip_alone2.pth")
    parser.add_argument('--model2_weight', type=str, default="/home/daehyun/KNN_final/only12/weight_re/sip_both2.pth")
    parser.add_argument('--model3_weight', type=str, default="/home/daehyun/KNN_final/only12/weight_re/sip_transfer2.pth")
    ...
    eval_dataset1_both = EvalDataset1_sip_both(args.data)
    eval_dataloader1_both = DataLoader(dataset=eval_dataset1_both, batch_size=1)
    eval_dataset2_both = EvalDataset2_sip_both(args.data)
    ...
    f1_score_2 = f1_score(label2, custom_predict2, labels=None, average='weighted')
    ...
    f1_score_3 = f1_score(label3, custom_predict3, labels=None, average='weighted')
